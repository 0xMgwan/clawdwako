  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 mt-2 w-64 bg-background border border-border rounded-lg shadow-lg z-[100]">
                      ...
                      <div className="p-2">
                        ...
                        <a href="mailto:support@nedapay.xyz" className="w-full">
                          <button
                        ...
                        <a href="https://t.me/Chuche0x" target="_blank" rel="noopener noreferrer" className="w-full">
                          <button
                            onClick={() => setShowUserMenu(false)}
                            className="w-full flex items-center px-3 py-2 text-sm text-foreground hover:bg-accent rounded-md transition-colors"
                          >
      ...
      <section className="relative min-h-screen bg-background px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto pt-8 lg:pt-12 pb-4 lg:pb-8">
          {/* Top Section - Title */}
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            ...
            <div className="space-y-8 lg:space-y-12">
              ...
              {/* Specs Grid */}
              <div className="grid grid-cols-2 gap-x-4 gap-y-2 lg:gap-x-6 lg:gap-y-3">
                <div>
                  <div className="text-xs tracking-wider text-muted-foreground mb-0.5">RESPONSE TIME</div>
                  <div className="text-2xl font-light">&lt; 2s <span className="text-sm text-muted-foreground">(avg)</span></div>
                </div>
                <div>
                  <div className="text-xs tracking-wider text-muted-foreground mb-0.5">ACCURACY</div>
                  <div className="text-2xl font-light">99.9% <span className="text-sm text-muted-foreground">(verified)</span></div>
                </div>
                <div>
                  <div className="text-xs tracking-wider text-muted-foreground mb-0.5">LANGUAGES</div>
                  <div className="text-2xl font-light">95+ <span className="text-sm text-muted-foreground">(supported)</span></div>
                </div>
                <div>
                  <div className="text-xs tracking-wider text-muted-foreground mb-0.5">DEPLOY TIME</div>
                  <div className="text-2xl font-light">&lt; 60s</div>
                </div>
                <div>
                  <div className="text-xs tracking-wider text-muted-foreground mb-0.5">UPTIME</div>
                  <div className="text-2xl font-light">24/7</div>
                </div>
                <div>
                  <div className="text-xs tracking-wider text-muted-foreground mb-0.5">AI MODELS</div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-base leading-relaxed text-muted-foreground">
                    Clawdwako is your personal openclaw AI agent. Connect your Telegram, choose your AI brain (Claude, GPT, or Gemini) and simply deploy, that's it. Your agent instantly becomes available to handle thousands of tasks. From answering questions and translating messages to automating customer support and managing workflows.
                  </p>
      ...
      <footer className="border-t border-border bg-background/95 backdrop-blur-sm mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="border-t border-border mt-8 pt-8 flex flex-row justify-between items-center">
            <p className="text-xs text-muted-foreground">
